...
class FHMealItem extends StatelessWidget {
  final FHMealModel _meal;
  FHMealItem(this._meal);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: (){
        Navigator.of(context).pushNamed(FHDetailScreen.routeName, arguments: _meal);
      },
    );
  }
      ...
      children: <Widget>[
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Text(_meal.title, style: Theme.of(context).textTheme.display3.copyWith(
              color: Colors.white
            ),),
          ),
        )
  ...
  Widget buildOperationInfo() {
    return Row(
      ...
      children: <Widget>[
        FHOperationItem(Icon(Icons.schedule),"${_meal.duration}分钟"),
        FHOperationItem(Icon(Icons.restaurant),"${_meal.complexStr}"),
        buildFavorItem()
      ],
    );
  }
